...
fp_mass = os.path.join(ROOT_DIR,'SIL-Results/PCA/Mass/')
fp_size = os.path.join(ROOT_DIR,'SIL-Results/PCA/Size/')
fp_xradius = os.path.join(ROOT_DIR,'SIL-Results/PCA/Xradius/')
fp_yradius = os.path.join(ROOT_DIR,'SIL-Results/PCA/Yradius/')

PCA_physics(ball_parameter='mass',df=data_mass,fp=fp_mass,n_config=n_config,curriculum_step=curriculum_step)
PCA_physics(ball_parameter='size',df=data_size,fp=fp_size,n_config=n_config,curriculum_step=curriculum_step)
PCA_physics(ball_parameter='xradius',df=data_xradius,fp=fp_xradius,n_config=n_config,curriculum_step=curriculum_step)
PCA_physics(ball_parameter='yradius',df=data_yradius,fp=fp_yradius,n_config=n_config,curriculum_step=curriculum_step)
